...
export const EXERCISES: Exercise[] = [
  ...
  { name: "Lat pulldown", primary: ["back"], secondary: ["biceps", "shoulders"], equipment: "cable", pattern: "pull" },
  ...
  { name: "Cable row", primary: ["back"], secondary: ["biceps", "rear_delts"], equipment: "cable", pattern: "pull" },
