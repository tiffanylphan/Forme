...
export const EXERCISES: Exercise[] = [
  ...
  {
    name: "Banded wall sit",
    aliases: ["Wall sit with resistance band", "Wall sits with resistance band", "Banded wall sits"],
    primary: ["quads", "glutes"],
    secondary: ["core", "adductors"],
    equipment: "band",
    pattern: "squat",
  },
  { name: "Banded wall sit abduction pulses", primary: ["quads", "glutes"], secondary: ["core"], equipment: "band", pattern: "squat" },
