...
export const EXERCISES: Exercise[] = [
  ...
  { name: "DB fwd -> reverse lunge", aliases: ["DB forward to reverse lunge", "DB forward and reverse lunge"], primary: ["quads", "glutes"], secondary: ["hamstrings", "core"], equipment: "dumbbell", pattern: "squat" },
  ...
  {
    name: "Box step-up",
    aliases: ["DB box step-up", "DB box step ups", "DB box step-up", "DB step ups", "DB step-up"],
  ...
  { name: "DB clean -> press", aliases: ["DB clean to press", "DB clean and press", "Dumbbell clean and press"], primary: ["shoulders", "glutes"], secondary: ["back", "core", "triceps", "hamstrings"], equipment: "dumbbell", pattern: "conditioning" },
  ...
  { name: "Plank up-down", primary: ["core"], secondary: ["shoulders", "triceps"], equipment: "bodyweight", pattern: "push", aliases: ["Plank up downs"] },
  ...
  { name: "Plank drag", aliases: ["Dumbbell drag", "Dumbbell drags", "DB drag"], primary: ["core"], secondary: ["shoulders", "back"], equipment: "dumbbell", pattern: "core" },
  ...
  { name: "Kneeling chop", aliases: ["Kneeling chops", "Half-kneeling chop", "Half kneeling chop", "Kneeling cable chop"], primary: ["core"], secondary: ["shoulders", "back"], equipment: "cable", pattern: "core" },
